...
app.get("/", (request, response) => {
    const selectCommand = "SELECT * FROM filmes_LecianeLeonardo"
...
app.delete("/delete/:id", (request, response) => {
    ...
    const deleteCommand = "DELETE FROM filmes_LecianeLeonardo WHERE id=?"
...
app.put("/update/:id", (request, response) => {
    ...
    const updateCommand = "UPDATE filmes_LecianeLeonardo SET title = ?, gender = ?, ageLimit = ?, duration = ? WHERE id = ?"
